...
class A3CModel(nn.Module):
    def __init__(self, obs_shape, num_actions, lr=0.001):
        ...
        self.conv_net = torch.nn.Sequential(
            ...
            torch.nn.Conv2d(obs_shape[0], 32, 5, stride=1, padding=2),
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(2, 2),
            torch.nn.Conv2d(32, 32, 5, stride=1, padding=1),
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(2, 2),
            torch.nn.Conv2d(32, 64, 4, stride=1, padding=1),
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(2, 2),
